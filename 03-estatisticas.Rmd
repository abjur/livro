...
Então o que fizemos quando construímos a Figura \@ref(fig:distancia) foi representar graficamente o módulo das diferenças entre o valor e a média. Em seguida, computamos essas distâncias na Tabela \@ref(tab:dados-com-desvio). Em termos matemáticos, fizemos a seguinte operação:
